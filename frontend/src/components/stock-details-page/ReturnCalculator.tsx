        ...
        <div className="sip-calculator">
          <div className="sip-input-panel">
            ...
            <div className="sip-search-wrapper">
              <svg className="sip-search-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <input
                ...
                defaultValue="Reliance Industries"
                placeholder="Search any stock, MF, F&O (E.g: HDFC Bank)"
              />
            </div>
            <div className="sip-amount-header">
              <div className="sip-input-label">Your Investment Amount</div>
